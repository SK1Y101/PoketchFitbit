...
function mapToDeviceSupportedLocale(tag) {
    if (tag === 'en-SE')
        return 'sv-SE';
    if (tag === 'en-NL')
        return 'nl-NL';
...
export default function gettextFactory(langTable, currentLocale = defaultLocale, fallbackLocale = defaultLocale) {
