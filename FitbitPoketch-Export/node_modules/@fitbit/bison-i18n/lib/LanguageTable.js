...
exports.LanguageTable = exports.TranslationLoader = exports._Message = void 0;
...
var TranslationLoader = (function () {
    ...
    TranslationLoader.prototype.loadLanguage = function (language, podata) {
        ...
        try {
            for (var _b = tslib_1.__values(po.items), _c = _b.next(); !_c.done; _c = _b.next()) {
...
var LanguageTable = (function () {
    ...
    LanguageTable.prototype.getLanguage = function (language) {
        ...
        try {
            for (var _c = tslib_1.__values(this.messages.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
                var _e = tslib_1.__read(_d.value, 2), id = _e[0], message = _e[1];
