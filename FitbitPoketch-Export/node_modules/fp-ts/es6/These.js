...
import { fromOption as fromOption_, fromOptionK as fromOptionK_ } from './FromEither';
 ...
 * @since 2.10.0
 */
export var matchW = function (onLeft, onRight, onBoth) { return function (fa) {
    switch (fa._tag) {
        case 'Left':
...
export function getShow(SE, SA) {
    return {
        show: match(function (l) { return "left(" + SE.show(l) + ")"; }, function (a) { return "right(" + SA.show(a) + ")"; }, function (l, a) { return "both(" + SE.show(l) + ", " + SA.show(a) + ")"; })
    };
}
/**
 * @category instances
 ...
 * @since 2.11.0
 */
export var elem = function (E) { return function (a) { return function (ma) {
 ...
 * @since 2.10.0
 */
export var toTuple2 = function (e, a) { return function (fa) {
 ...
 * @since 2.11.0
 */
export var traverseReadonlyNonEmptyArrayWithIndex = function (S) { return function (f) { return function (as) {
    var e = _.none;
    var t = f(0, _.head(as));
    if (isLeft(t)) {
        return t;
