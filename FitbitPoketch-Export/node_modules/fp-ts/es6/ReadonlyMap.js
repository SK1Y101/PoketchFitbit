 ...
 * @since 2.5.0
 */
export var keys = function (O) { return function (m) {
 ...
 * @since 2.5.0
 */
export var values = function (O) { return function (m) {
 ...
 * @since 2.5.0
 */
export var filterMap = function (f) { return function (fa) { return _filterMap(fa, f); }; };
/**
 ...
 * @since 2.7.1
 */
export var mapWithIndex = function (f) { return function (fa) { return _mapWithIndex(fa, f); }; };
/**
 * @category Filterable
 * @since 2.5.0
 */
